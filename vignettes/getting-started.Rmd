...
```{r plot-mediation-result-summary-all}
...
```{r plot-mediation-result-summary-acme-only}
plot_mediation_summary_effects(med_summary,
  filter_significant = TRUE,
  show_only_acme = TRUE,
  summary_plot = TRUE
...
```{r plot-mediation-result-per-pathway}
plot_mediation_summary_effects(med_summary,
  filter_significant = TRUE,
  summary_plot = FALSE
)
...
```{r plot-mediation-result-per-pathway-acme}
plot_mediation_summary_effects(med_summary,
  filter_significant = TRUE,
  summary_plot = FALSE,
  show_only_acme = TRUE
